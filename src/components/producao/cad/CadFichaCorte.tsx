  ...
  return (
    <div className="print-area">
      ...
      <div style={{ marginTop: 40, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, fontSize: 12 }}>
        <div><div style={{ borderTop: "1px solid #000", paddingTop: 4 }}>Nome (Cortador)</div></div>
        <div><div style={{ borderTop: "1px solid #000", paddingTop: 4 }}>Assinatura</div></div>
        <div><div style={{ borderTop: "1px solid #000", paddingTop: 4 }}>Nome (Recebedor)</div></div>
        <div><div style={{ borderTop: "1px solid #000", paddingTop: 4 }}>Assinatura</div></div>
      </div>
    </div>
  );
