...
// Espelha oc-p-acabado/OcPaRecebimento.tsx byte-a-byte — mesma seção 4 (Recebimento), só
// renumerada pra seção 6 aqui (a OC Importado ganhou 2 seções a mais: Câmbio + Etapas).
export function OcImpRecebimento({
  draft, setDraft,
  grade, setGrade,
  tamanhos,
  cores, coresApelido,
