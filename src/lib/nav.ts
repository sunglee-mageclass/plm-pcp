...
export const PAGE_URLS: Record<string, string> = {
  ...
  entrada_oc_p_importado: "/entrada-saida/oc-p-importado",
  ...
  criacao_produto_importado: "/criacao/produto-importado",
...
export const PAGE_ICONS: Record<string, LucideIcon> = {
  ...
  entrada_oc_p_importado: ShoppingCart,
  ...
  criacao_produto_importado: Package,
...
export const BADGE_CLS: Record<string, string> = {
  ...
  entrada_oc_p_importado: "bg-red-600 text-white",
...
export function pageBadgeCounts(b?: Record<string, number>): Record<string, number> {
  ...
  return {
    ...
    entrada_oc_p_importado: n("oc_importado_atrasada"),
...
export function badgeViva(key: string, n: number): string | null {
  ...
  switch (key) {
    ...
    case "entrada_oc_p_acabado":
    case "entrada_oc_p_importado": return `${n} OC${um ? "" : "s"} atrasada${um ? "" : "s"}`;
