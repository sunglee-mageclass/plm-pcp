...
function DirListPage() {
  ...
  const { data: rows = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      // `cad_grades`) nasce direto em `receber_oc_p_acabado`/`receber_oc_importado`. Sem o
      // `.or(...)` abaixo, um modelo comprado com OC recebida nunca aparecia aqui, mesmo
      // com CQ liberado (`cqLiberado` já é origem-agnóstico — só faltava esta linha buscar
