...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "WISH360 — PLM + PCP para Moda e Confecção" },
      { name: "description", content: "WISH360: sistema multi-tenant de PLM e PCP para gestão de criação, produção, estoque e financeiro em moda e confecção." },
      { property: "og:site_name", content: "WISH360" },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "WISH360 — PLM + PCP para Moda e Confecção" },
