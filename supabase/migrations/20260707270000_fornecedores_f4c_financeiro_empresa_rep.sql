-- FORNECEDORES — F4c: servicos_financeiro devolve empresa e representante SEPARADOS + CNPJs.
-- Pra tela de financeiro (aba Serviços) mostrar 'Empresa' e 'Representante' (não 'Responsável'),
-- com o CNPJ certo (empresa direto; ou do representante). Mantém responsavel/responsavel_cnpj.
