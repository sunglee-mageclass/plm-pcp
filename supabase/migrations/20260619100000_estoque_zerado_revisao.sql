-- Estoque zerado, revisão: (1) cálculo sem 'baixa real' (ledger) — item
-- zerado contribui recebido=0 e o físico da variante é travado em >=0;
-- (2) pode_zerar exige >=1 modelo (com 0 modelos NÃO pode zerar).
