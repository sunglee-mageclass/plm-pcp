-- 20260734100100_plan_tecido_pedido_campos_oc.sql — Plan. Tecido: wizard preenche mais campos da OC.
-- Inclui no pedido: observacoes_entrega, responsavel_nome e parcelas_recebimento (parcelamento de ENTREGA,
-- array [{data, recebido:false}]). _salvar_oc_tecido_core já persiste esses campos do _oc.
begin;
