-- OCs/itens elegíveis para separar um rolo: só status recebido, não-rolo, item
-- não cancelado, NÃO zerado e com saldo físico (recebido − baixa) > 0.
  ...
  FROM (
    ...
    JOIN LATERAL (
      SELECT jsonb_agg(jsonb_build_object(
               ...
               'disponivel_m', disp.m
             ) ORDER BY vt.nome_variante) AS arr
