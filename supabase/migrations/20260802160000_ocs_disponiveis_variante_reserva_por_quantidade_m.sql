-- Over-reserva: ocs_disponiveis_variante reservava a NECESSIDADE cheia por vínculo (recomputava
-- consumo×grade×mult), então uma variante coberta por 2+ OCs reservava o total em CADA item →
-- disponibilidade fantasma negativa p/ outros modelos. Agora reserva o quantidade_m ALOCADO.
BEGIN;
