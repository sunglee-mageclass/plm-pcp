-- CAD grade real (invariante #6): _salvar_cad_completo_core passa a REIDRATAR a grade real
-- confirmada (CQ) de variantes que o front omitir do payload _grades — antes o DELETE+reinsert
-- só preservava as variantes reenviadas, apagando as omitidas.
