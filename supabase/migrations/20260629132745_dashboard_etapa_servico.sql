-- Nomenclatura: etapa do dashboard 'Terceirizado' -> 'Serviço' (UI). A RPC calcula a
-- etapa ao vivo (sem dado armazenado), então sem backfill. producao_terceirizados (tabela) fica.
