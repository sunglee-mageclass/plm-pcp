-- Fase 6 (item 33): + taxa de defeito por mês no dashboard de Produção.
-- Estende o _core; wrapper de permissão intacto.
...
DECLARE
  ...
  v_timeline jsonb; v_kanban jsonb; v_sla jsonb; v_cortes jsonb; v_finalizadas jsonb; v_defeito_mes jsonb;
