-- 20260725100500_plan_tecido_arvore_foto.sql — thumb_path segue a hierarquia de imagem do modelo
-- (croqui → desenho técnico → foto de modelo → foto de referência), igual à semeadura no front.
begin;
          ...
          select jsonb_agg(jsonb_build_object(
            ...
            'slots', coalesce((
              select jsonb_agg(jsonb_build_object(
                ...
                'thumb_path', coalesce(m.croqui_url, m.desenho_tecnico_url, (m.fotos_modelo)[1], (m.fotos_referencia)[1]),
