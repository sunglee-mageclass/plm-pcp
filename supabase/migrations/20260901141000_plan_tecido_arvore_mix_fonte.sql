-- Fonte única do mix por slot: modelo REAL → modelos.mix_id (o que o Editar Mix/Mover/Plan.Produto
-- grava, update direto); VAGA (sem modelo) → plan_tecido_slots.mix_id (drag/picker de vaga). Assim
-- 'remover do mix' num modelo real (m.mix_id=null) reflete na lane mesmo se o slot tiver valor velho,
-- e a vaga mantém sua reserva. Substitui o coalesce da 20260901140000.
