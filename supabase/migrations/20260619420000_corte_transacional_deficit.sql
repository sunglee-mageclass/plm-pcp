-- P0-2 + P0-3: "enviar ao corte" atômico + déficit visível.
-- Antes: o front fazia UPDATE cad SET enviado_corte=true e DEPOIS chamava esta
-- RPC; se a baixa falhasse, o CAD ficava enviado sem baixa (P0-2). E a baixa
-- podia sair parcial (LEAST(restante,saldo,limite)) sem aviso (P0-3).
--
-- Agora a RPC: (1) marca enviado_corte/status_corte/data dentro da própria
-- transação (atômico com a baixa); (2) acumula o déficit por variante (o que
-- faltou baixar de metragem_enviada) e o retorna para o front exibir.
