-- Consumo por OC: rótulo da variante passa a "nome comercial - cor - apelido"
-- (antes era COALESCE priorizado que mostrava só um). Junta as partes não-vazias
-- com " - "; cai p/ codigo_variante e, por fim, "—". Espelha src/lib/variante.ts.
