-- ocs_disponiveis_variante: também devolve a OC de ORIGEM de cada rolo (via
-- rolo_origem_item_id). No modo Híbrido, o Desenvolvimento agrupa os rolos pela OC de
-- origem (e separa os avulsos = sem origem). Não muda nada para Somente OC / Somente Rolo.
