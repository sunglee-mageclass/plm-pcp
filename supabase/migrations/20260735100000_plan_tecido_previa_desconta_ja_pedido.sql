-- 20260735100000_plan_tecido_previa_desconta_ja_pedido.sql — 2º pedido não duplica.
-- Déficit = necessidade CHEIA − o que ESTE plano já pediu (plan_tecido_ocs). Ignora estoque geral.
-- OC excluída sai de plan_tecido_ocs (cascade) → volta a ser pedida.
begin;
