-- Leadtime: a RPC per-item passa a devolver o SLA da Subcategoria 1 do modelo
-- (subcategorias1_produto.sla_oficina — o "SLA de Serviços") p/ a matriz comparar a
-- coluna de Serviços do item contra o prazo da SUA subcategoria (varia por produto).
-- Só adiciona 'sub1_sla' ao retorno; o resto do _core segue igual.
