-- Badges de #Erro (revisao_pendente) no sidebar, ao lado de Serviços, CQ e Direcionamento.
-- revisao_pendente é jsonb por etapa, ex.: {"cq":true,"terceirizados":true,"direcionamento":true}.
-- Estende sidebar_badges com 3 contadores (erro_terceirizados/erro_cq/erro_direcionamento).
BEGIN;
...
BEGIN
  ...
  -- #Erro (revisão pendente) por etapa — contagem de modelos do tenant com a flag true.
