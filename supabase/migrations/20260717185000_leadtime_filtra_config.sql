-- Leadtime — Fase 2 (backend): a config da loja (tenant_config.leadtime.etapas) passa a
-- FILTRAR e ORDENAR quais etapas a aba mostra (o dono escolhe o que acompanhar + o ideal
-- de cada). Sem config = bootstrap: mostra TODAS com default (macro 7d / kanban 5d).
-- Só redefine o _core; o wrapper dashboard_leadtime() e os REVOKEs continuam válidos.
