-- Plan. Tecido item 15: o rótulo da variante deve ser apenas "cor base - cor apelido" (SEM o
-- nome_variante). _plan_tecido_arvore_core montava o label com concat_ws(nome_variante, cor, apelido);
-- passa a montar só (cor, apelido). Só muda a expressão do 'label'; resto idêntico.
